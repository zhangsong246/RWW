...
var routes = [
    ...
    { path: 'mock-datas', component: mock_data_component_1.MockDataComponent },
    { path: 'first', component: first_component_1.FirstComponent },
    { path: 'first-stand-alone', component: first_stand_alone_component_1.FirstStandAloneComponent }
];
